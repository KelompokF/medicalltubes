...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:8080", "http://127.0.0.1:8080", "https://medicalltubes-frontend-production.up.railway.app", "https://tender-creativity-production-f6d1.up.railway.app", "http://localhost:5173"],
